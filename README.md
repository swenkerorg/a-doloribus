# @swenkerorg/a-doloribus <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```js
var getDescriptors = require('@swenkerorg/a-doloribus');
...
[package-url]: https://npmjs.org/package/@swenkerorg/a-doloribus
...
[npm-badge-png]: https://nodei.co/npm/@swenkerorg/a-doloribus.png?downloads=true&stars=true
[license-image]: http://img.shields.io/npm/l/@swenkerorg/a-doloribus.svg
[license-url]: LICENSE
[downloads-image]: http://img.shields.io/npm/dm/@swenkerorg/a-doloribus.svg
[downloads-url]: http://npm-stat.com/charts.html?package=@swenkerorg/a-doloribus
